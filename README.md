...
The final *.td file then store tandem duplication calls for following analysis. For example, the bed_filtering.py could bed used to check and filter unexpected call whose length is not as long as pre-defined by us. 
